      ...
      <div className="bg-gray-100 min-h-screen py-12">
        <div className="max-w-6xl mx-auto bg-white shadow-lg rounded-2xl p-8">
          ...
          <Section
            icon={visionIcon}
            title="Vision"
            text="RDF envisions a socio-economically just and equitable society and capitalization ofthe potentials of women and
children along with intersectional inclusiveness."
            image={visionImage}
            reverse={false}
          />
          ...
          <Section
            icon={missionIcon}
            title="Mission"
            text="“The Institutional Mission is to bring positive changes and ensure human rights for the poor and
disadvantaged people, especially women and children in education, technical skills, health, economic,
resilience to climate change with actions and socio-cultural environment both in rural and urban areas.
"
            image={missionImage}
            reverse={true}
          />
